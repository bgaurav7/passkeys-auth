...
class SignUpFragment : Fragment() {
    ...
    private suspend fun createPassword() {
        ...
        try {
            ...
            Log.e(TAG, "createPassword failed with exception: " + e.message)
        }
    }
    ...
    private fun signUpWithPasskeys(): View.OnClickListener {
        return View.OnClickListener {
            ...
            if (binding.username.text.isNullOrEmpty()) {
                ...
                Log.i(TAG, "Signature: " + Signature.getApplicationSignature(requireContext()))
                ...
                call.enqueue(object : Callback<JsonObject> {
                    override fun onResponse(call: Call<JsonObject>, response: Response<JsonObject>) {
                        ...
                        lifecycleScope.launch {
                            ...
                            val data = createPasskey(registerReq)

                            configureViews(View.INVISIBLE, true)

                            data?.let {
                                registerResponse(username, data.registrationResponseJson)
                            }
                        }
                    }
        ...
        callEnd.enqueue(object : Callback<JsonObject> {
            override fun onResponse(
                ...
                if(response.code() == 200) {
                    ...
                    val message = "Unable to register using passkeys"
                    activity?.showErrorAlert(message)
                }
            }
